(function ($, window, document, undefined) {
    ...
    'use strict';
    var animationArr = ['doubleBounce', 'wave', 'wanderingCubes', 'changingDots', 'threeBounce', 'circle', 'cubeGrid', 'fadingCircle', 'foldingCube',]
    ...
    function Plugin(element, options) {
        ...
        this.animations = {
            ...
            rotatingPlane: {
                html: '<div class="sk-rotating-plane"></div>', setBackground: function (color) {
            ...
            changingDots: { html: '<div class="sk-chasing-dots"><div class="sk-child sk-dot1"></div><div class="sk-child sk-dot2"></div></div>' },
            ...
            circle: {
                html: '<div class="sk-circle"> <div class="sk-circle1 sk-child"></div> <div class="sk-circle2 sk-child"></div> <div class="sk-circle3 sk-child"></div> <div class="sk-circle4 sk-child"></div> <div class="sk-circle5 sk-child"></div> <div class="sk-circle6 sk-child"></div> <div class="sk-circle7 sk-child"></div> <div class="sk-circle8 sk-child"></div> <div class="sk-circle9 sk-child"></div> <div class="sk-circle10 sk-child"></div> <div class="sk-circle11 sk-child"></div> <div class="sk-circle12 sk-child"></div> </div>', setBackground: function (color) {
            ...
            fadingCircle: {
                html: '<div class="sk-fading-circle"> <div class="sk-circle1 sk-circle"></div> <div class="sk-circle2 sk-circle"></div> <div class="sk-circle3 sk-circle"></div> <div class="sk-circle4 sk-circle"></div> <div class="sk-circle5 sk-circle"></div> <div class="sk-circle6 sk-circle"></div> <div class="sk-circle7 sk-circle"></div> <div class="sk-circle8 sk-circle"></div> <div class="sk-circle9 sk-circle"></div> <div class="sk-circle10 sk-circle"></div> <div class="sk-circle11 sk-circle"></div> <div class="sk-circle12 sk-circle"></div> </div>', setBackground: function (color) {
                    $that.animationBox.children().find('*').each(function (k, e) {
                        if (window.getComputedStyle(e, ':before').getPropertyValue('background-color') !== 'rgba(0, 0, 0, 0)') {
                            $('body').append($('<style data-custom-style>.' + $(e).attr('class').split(' ')[0] + ':before {background-color: ' + color + ' !important;}</style>'));
                        }
            ...
            foldingCube: {
                html: '<div class="sk-folding-cube"> <div class="sk-cube1 sk-cube"></div> <div class="sk-cube2 sk-cube"></div> <div class="sk-cube4 sk-cube"></div> <div class="sk-cube3 sk-cube"></div> </div>', setBackground: function (color) {
                    $that.animationBox.find('*').each(function (k, e) {
                        if (window.getComputedStyle(e, ':before').getPropertyValue('background-color') !== 'rgba(0, 0, 0, 0)') {
                            $('body').append($('<style data-custom-style>.' + $(e).attr('class').split(' ')[0] + ':before {background-color: ' + color + ' !important;}</style>'));
                        }
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            this.currentAnimation = this.animations[this.settings.animation];
            $animationBox.append(this.currentAnimation.html);
            ...
            this.backgroundDismiss(this.settings.backgroundDismiss);
        ...
        backgroundDismiss: function (dismiss) {
            if (dismiss) {
                var $th = this;
                $('body').on('click', '.jquery-loading-modal', function () {
        ...
        color: function (color) {
            ...
            if (this.currentAnimation.setBackground) {
                this.currentAnimation.setBackground(color);
            } else {
        ...
        animation: function (animation) {
            ...
            this.animationBox.append(this.currentAnimation.html);
        },
        destroy: function () {
            $('[data-custom-style]').remove();
            this.modal.remove();
