...
class Format
{
     ...
     *
     * @param null|mixed $data Optional data to pass, so as to override the data passed
     *                         to the constructor
     *
...
if ('_attributes' === $key && (is_array($value) || is_object($value))) {
$attributes = $value;
